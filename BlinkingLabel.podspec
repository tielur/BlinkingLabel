...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/tielur/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Tyler Clemens" => "tyler.r.clemens@gmail.com" }
  s.source           = { :git => "https://github.com/tielur/BlinkingLabel.git", :tag => s.version.to_s }
